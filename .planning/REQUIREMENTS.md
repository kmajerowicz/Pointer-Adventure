...
- [x] **FILT-01**: Filter panel opens as bottom sheet with sticky "Zastosuj" button
...
- [x] **FILT-08**: Active filter count badge shown on filter trigger button; horizontal chip bar shows applied filters with × to remove
...
- [x] **FAV-03**: Favorites page lists all saved trails with reusable filter controls
- [x] **FAV-04**: User can add/edit private note per favorite trail
- [x] **FAV-05**: Empty favorites shows personalized message: "Nie masz jeszcze ulubionych tras. Znajdź coś dla [dog name]!" + CTA

### Activity

- [x] **ACT-01**: TrailDetail shows "Przeszedłem!" button for authenticated users
...
- [x] **PWA-06**: PNG icons (192x192, 512x512) replace SVG placeholders for iOS compatibility
- [x] **PWA-07**: Manifest: `display: standalone`, theme color `#111318`, portrait orientation
